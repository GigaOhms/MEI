...
bool S_LED2 = 0;
bool SS_LED2 = 0;
bool S_RL = 0;             // Trang thai relay Onboard
bool SS_RL = 0;
bool S_RL_CLI = 0;         // Trang thai Relay RE485
bool S_SENSOR;             // Trang thai Sensor ----- 1: Co nguoi ------- 0: khong co nguoi
bool SS_SENSOR;
...
uint8_t modeControl = 1;    // ------ 1: Dieu khien relay RS485 ---------- 0: Dieu khien relay Onboard
bool manualStt = 0;         // ------ 1: Dieu khien bang nut nhan -------- 0: Dieu khien tu dong
uint8_t autoMode = 1;       // ------ 1: auto             ---------------- 0: luon luon OFF thiet bi
uint8_t lockDevice = 0;     // ------ 1: luon luon ON thiet bi ----------- 0: auto -------- [uu tien cao nhat]
